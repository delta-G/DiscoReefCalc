 ...
 * @author David
 */
public class SetDailyDoseDialog extends JDialog {
    ...
    public SetDailyDoseDialog(Tank atank) {
        this.tank = atank;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        model = new DefaultComboBoxModel(tank.getDosingProducts().toArray());
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {  
       ...
       this.tank.setDailyDose(DosingComputer.parseDosingProduct(model.getSelectedItem().toString()), Preferences.getDoseVolumeUnit().convertFromUnit(ret));
    ...
    private void productComboBoxActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        doseField.setText(DosingComputer.guiFrame.getCurrentTank().getDailyDose(DosingComputer.parseDosingProduct(model.getSelectedItem().toString())).toString());
    }
